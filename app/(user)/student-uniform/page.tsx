...
async function getCachedSeoContent(instituteId: string) {
   "use cache";
   return await getSeoContent(instituteId, "student-uniform");
}
...
export default async function StudentUniformPage() {
   const instituteId = await getInstituteId();
   ...
   const content = await getPageContent("student-uniform", instituteId);
