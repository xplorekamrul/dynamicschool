...
async function getCachedSeoContent(instituteId: string) {
   "use cache";
   return await getSeoContent(instituteId, "clubs");
}
...
export default async function ClubsPage() {
   ...
   const content = await getPageContent("clubs", instituteId);
   // console.log("[Clubs Page] Content fetch result:", { slug: "clubs", instituteId, contentFound: !!content });
