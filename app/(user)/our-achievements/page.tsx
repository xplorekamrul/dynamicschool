...
async function getCachedSeoContent(instituteId: string) {
  "use cache";
  return await getSeoContent(instituteId, "our-achievements");
}
...
export async function generateMetadata() {
  ...
  const metadata = {
    title: seoContent.title || "Our Achievements",
...
export default async function OurAchievementsPage() {
  ...
  const content = await getPageContent("our-achievements", instituteId);
