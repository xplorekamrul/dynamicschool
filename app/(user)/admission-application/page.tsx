...
async function getCachedSeoContent(instituteId: string) {
   "use cache";
   return await getSeoContent(instituteId, "admission-application");
}
...
export async function generateMetadata() {
   ...
   const metadata = {
      title: seoContent.title || "Admission Application",
...
export default async function AdmissionApplicationPage() {
   ...
   const content = await getPageContent("admission-application", instituteId);
