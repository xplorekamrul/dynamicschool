...
async function getCachedSeoContent(instituteId: string) {
  "use cache";
  return await getSeoContent(instituteId, "goals-and-objectives");
}
...
export async function generateMetadata() {
  ...
  return {
    title: seoContent.title || "Goals and Objectives",
...
export default async function GoalsAndObjectivesPage() {
  const instituteId = await getInstituteId();
  ...
  const content = await getPageContent("goals-and-objectives", instituteId);
