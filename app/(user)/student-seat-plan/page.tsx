...
async function getCachedSeoContent(instituteId: string) {
  "use cache";
  return await getSeoContent(instituteId, "student-seat-plan");
}
...
export async function generateMetadata() {
  ...
  return {
    title: seoContent.title || "Student Seat Plan",
...
export default async function StudentSeatPlanPage() {
  const instituteId = await getInstituteId();
  ...
  const content = await getPageContent("student-seat-plan", instituteId);
