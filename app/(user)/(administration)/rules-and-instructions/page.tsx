...
async function getCachedSeoContent(instituteId: string) {
    "use cache";
    return await getSeoContent(instituteId, "rules-and-instructions");
}
...
export async function generateMetadata() {
    ...
    return {
        title: seoContent.title || "Rules and Instructions",
...
export default async function RulesAndInstructionsPage() {
    const instituteId = await getInstituteId();
    ...
    const content = await getPageContent("rules-and-instructions", instituteId);
