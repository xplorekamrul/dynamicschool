...
async function getCachedSeoContent(instituteId: string) {
  "use cache";
  return await getSeoContent(instituteId, "organization-infrastructure");
}
...
export async function generateMetadata() {
  ...
  return {
    title: seoContent.title || "Organization Infrastructure",
...
export default async function OrganizationInfrastructurePage() {
  const instituteId = await getInstituteId();
  ...
  const content = await getPageContent("organization-infrastructure", instituteId);
